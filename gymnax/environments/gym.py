...
class GymnaxToGymWrapper(gym.Env):
    def __init__(
        ...
        Args:
            ...
            seed: If provided, seed for JAX PRNG (otherwise picks at random)
        """
        super().__init__()
    ...
    def step(
        ...
        return o, r, d, d, info  # new step API has done and truncated
    ...
    def render(self, mode="human") -> Optional[Union[RenderFrame, List[RenderFrame]]]:
        ...
        return self._env.render(self.env_state, self.env_params)
